/**
 * Generate SEO landing pages and rewrite secondary pages with shared chrome.
...
// Tech pages
const techs = [
  { slug: "react", name: "React", tags: "React" },
  { slug: "nodejs", name: "Node.js", tags: "Node.js,Node" },
  { slug: "python", name: "Python", tags: "Python" },
  { slug: "rust", name: "Rust", tags: "Rust" },
  { slug: "go", name: "Go", tags: "Go,Golang" },
  { slug: "ai", name: "AI", tags: "AI,ML,Machine Learning,LLM" },
];
...
for (const t of techs) {
  writeLanding({
    ...
    active: "jobs",
    title: `Remote ${t.name} Jobs — remotedevelopers`,
    description: `Find remote-only ${t.name} engineering jobs. Curated and partner listings for developers.`,
    canonical: `/tech/${t.slug}.html`,
    h1: `Remote ${t.name} Jobs`,
...
const locations = [
  ...
  { slug: "usa", name: "USA", keys: "usa,united states,america" },
  { slug: "europe", name: "Europe", keys: "europe,eu,emea,germany,france,netherlands" },
  { slug: "canada", name: "Canada", keys: "canada" },
  { slug: "uk", name: "UK", keys: "uk,united kingdom,london,britain" },
  { slug: "asia", name: "Asia", keys: "asia,india,singapore,japan,korea" },
  { slug: "latam", name: "LATAM", keys: "latam,latin,brazil,mexico,argentina" },
  { slug: "australia", name: "Australia", keys: "australia,new zealand" },
];
...
for (const loc of locations) {
  writeLanding({
    ...
    active: "jobs",
    title: `Remote Developer Jobs — ${loc.name} — remotedevelopers`,
    description: `Remote developer jobs for ${loc.name}. Curated remote-only engineering roles.`,
...
writeSimple({
  ...
  description: "Explore remote developer jobs by stack and salary. SEO hubs for React, Go, Rust, Python, and AI.",
  canonical: "/salary.html",
  body: `
      <div class="max-w-3xl mb-12" data-reveal>
        <h1 class="text-display-lg font-display">Salary pages</h1>
        <p class="text-muted mt-4 text-lg">Huge SEO opportunity — browse remote roles by stack and compensation.</p>
      </div>
      <div class="grid sm:grid-cols-2 gap-4">
        ${salaryPages
          .map(
            (s) =>
              `<a href="/salary/${s.slug}.html" class="browse-card" data-reveal><span class="font-semibold text-lg">${s.title}</span></a>`,
          )
          .join("\n")}
      </div>
  `,
  ...
  body: `
      ...
      <div class="grid sm:grid-cols-2 gap-4">
        ${guides
          .map(
            (g) =>
              `<a href="/guides/${g.slug}.html" class="browse-card" data-reveal><span class="font-semibold text-lg">${g.title}</span></a>`,
          )
          .join("\n")}
        <a href="/blog.html" class="browse-card" data-reveal><span class="font-semibold text-lg">More from the blog →</span></a>
      </div>
  `,
});
